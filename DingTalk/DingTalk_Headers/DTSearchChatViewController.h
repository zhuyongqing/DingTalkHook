...
@class DTEmptyResultView, DTLoadMoreController, DTSearchEngineResult, DTSearchLog, DTTableLoadingView, NSArray, NSString, UITableView;

@interface DTSearchChatViewController : DTContactBaseViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, DTLoadMoreDelegate>
{
    ...
    DTSearchEngineResult *_chatResult;
    DTSearchLog *_searchLog;
}

@property(retain) DTSearchLog *searchLog; // @synthesize searchLog=_searchLog;
@property(retain, nonatomic) DTSearchEngineResult *chatResult; // @synthesize chatResult=_chatResult;
...
- (void)showsChatListWithSearchText:(id)arg1;
- (id)itemsWithLoadMoreController:(id)arg1;
