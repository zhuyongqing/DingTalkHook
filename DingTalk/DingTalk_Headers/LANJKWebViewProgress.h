...
@protocol LANJKWebViewProgressDelegate, UIWebViewDelegate;

@interface LANJKWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <LANJKWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <LANJKWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void).cxx_destruct;
