...
@class BLAccount, DTEmptyResultView, DTLoadMoreController, DTSearchLog, NSMutableArray, NSString, UITableView;

@interface DTMailSearchResultsViewController : DTGlobalSearcherBaseViewController <UITableViewDataSource, UITableViewDelegate, DTLoadMoreDelegate>
{
    _Bool _isSearching;
...
- (void).cxx_destruct;
- (void)dt_searchMailDataWithSearchText:(id)arg1 offset:(long long)arg2 size:(long long)arg3;
- (void)searchMailDataWithSearchText:(id)arg1 offset:(long long)arg2 size:(long long)arg3;
