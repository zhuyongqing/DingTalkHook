...
#import "DTChannelApplyDetailDelegate-Protocol.h"
...
@interface DTChannelApplyListViewController : DTViewController <UITableViewDelegate, UITableViewDataSource, DTLoadMoreDelegate, DTGroupApplyListCellDelegate, DTChannelApplyDetailDelegate>
{
...
@property(copy) NSArray *datasource; // @synthesize datasource=_datasource;
...
- (void).cxx_destruct;
- (void)applyDetailController:(id)arg1 applyInfo:(id)arg2 didUpdateApplyStatus:(unsigned long long)arg3;
...
- (id)converChannelApplysToGroupApplys:(id)arg1;
