...
+ (id)polygonWithPoints:(struct MAMapPoint *)arg1 count:(unsigned long long)arg2 interiorPolygons:(id)arg3;
+ (id)polygonWithPoints:(struct MAMapPoint *)arg1 count:(unsigned long long)arg2;
- (void).cxx_destruct;
- (id)initWithPoints:(struct MAMapPoint *)arg1 count:(unsigned long long)arg2 interiorPolygons:(id)arg3;
- (id)initWithWithCoordinates:(struct CLLocationCoordinate2D *)arg1 count:(unsigned long long)arg2 interiorPolygons:(id)arg3;
- (unsigned long long)countOfInteriorPolygons;
- (id)interiorPolygonsAtIndexes:(id)arg1;
@property(readonly) NSArray *interiorPolygons;
- (_Bool)intersectsMapRect:(struct MAMapRect)arg1;
