...
@protocol DTChannelServiceProtocol <NSObject>
@property(retain, nonatomic) id <DTChannelServiceNetworkProtocol> networkIMP;
@property(retain, nonatomic) id <DTChannelServicePersistenceProtocol> persistenceIMP;
- (void)queryLocalAflowBusinessOrderWithOrgId:(long long)arg1 successBlock:(void (^)(DTBusinessOrder *))arg2 failureBlock:(void (^)(DTError *))arg3;
