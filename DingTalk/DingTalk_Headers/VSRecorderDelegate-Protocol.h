...
@optional
- (void)recorder:(VSRecorder *)arg1 didOutputSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;
- (void)recorder:(VSRecorder *)arg1 didStartRunningWithSession:(VSRecordSession *)arg2;
