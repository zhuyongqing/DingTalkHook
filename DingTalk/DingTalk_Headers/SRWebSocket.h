...
@protocol OS_dispatch_queue, SRWebSocketDelegate, WXWebSocketDelegate;
...
@property(nonatomic) __weak id <WXWebSocketDelegate> wx_WebSocketDelegate;
@property(copy, nonatomic) NSString *wx_Identifier;
