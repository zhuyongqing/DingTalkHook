...
@class DTReportItem, NSArray, NSIndexPath, NSString, UILabel, UITableView, UITextView, UIView;

@interface DTReportViewController : DTViewController <UITableViewDataSource, UITableViewDelegate, UITextViewDelegate>
{
    _Bool _hasEdited;
    DTReportItem *_item;
...
@property(retain, nonatomic) DTReportItem *item; // @synthesize item=_item;
- (void).cxx_destruct;
