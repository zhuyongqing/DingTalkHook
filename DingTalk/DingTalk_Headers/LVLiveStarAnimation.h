...
@interface LVLiveStarAnimation : UIView
{
    int _positionRange;
    float _duration;
    float _speedRange;
...
- (void).cxx_destruct;
- (void)popStarAnimationWithCount:(int)arg1 useDefaultImgs:(_Bool)arg2 step:(_Bool)arg3;
- (void)popStarAnimation:(_Bool)arg1 defaultImgs:(_Bool)arg2 step:(_Bool)arg3;
- (id)scaleYAnimation;
- (id)scaleXAnimation;
- (id)opacityAnimation;
