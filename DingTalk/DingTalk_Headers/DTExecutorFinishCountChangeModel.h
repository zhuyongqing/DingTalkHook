...
@interface DTExecutorFinishCountChangeModel : Marshal
{
    NSNumber *_dingId;
    NSNumber *_executorFinishCount;
    NSNumber *_version;
...
@property(retain, nonatomic) NSNumber *executorFinishCount; // @synthesize executorFinishCount=_executorFinishCount;
