...
@class DTContact, DTDepartment, DTEnterpriseCard, DTExternalContact, DTExternalContactField, DTExternalContactQuery, DTExternalLabelGroup, DTFeedback, DTFilterModel, DTFriendRequest, DTGroupInvite, DTLeavingReason, DTNameCardData, DTOrgEcAddress, DTOrgManagerRole, DTOrgUserHrmInfo, DTOrgUserName, DTOrganization, DTOwnness, DTRegion, DTReportItem, DTTeamCreation, DTUsualContact, NSArray, NSDate, NSNumber, NSString;
...
- (void)updateOwnness:(DTOwnness *)arg1 successBlock:(void (^)(NSString *))arg2 failureBlock:(void (^)(id <IMError>))arg3;
- (void)getStaticOwnnessList:(void (^)(NSArray *))arg1 failureBlock:(void (^)(id <IMError>))arg2;
- (_Bool)contactCanShowMainOrg:(DTContact *)arg1;
- (DTOrganization *)contactMainOrgIfCanShow:(DTContact *)arg1;
- (_Bool)contactIsColleague:(DTContact *)arg1;
...
- (void)updateOrgManagerRoleWithOrgId:(long long)arg1 model:(DTOrgManagerRole *)arg2 successBlock:(void (^)(DTOrgManagerRole *))arg3 failureBlock:(void (^)(id <IMError>))arg4;
- (void)addOrgManagerRoleWithOrgId:(long long)arg1 model:(DTOrgManagerRole *)arg2 successBlock:(void (^)(DTOrgManagerRole *))arg3 failureBlock:(void (^)(id <IMError>))arg4;
- (void)listForAllOrgManagerResourceWithOrgId:(long long)arg1 successBlock:(void (^)(DTOrgManagerResourceGroup *))arg2 failureBlock:(void (^)(id <IMError>))arg3;
- (void)subManagerGroupListWithOrgId:(long long)arg1 offset:(long long)arg2 size:(long long)arg3 successBlock:(void (^)(DTOrgManagerRoleList *))arg4 failureBlock:(void (^)(id <IMError>))arg5;
...
- (NSArray *)sortExternalContacts:(NSArray *)arg1;
...
- (void)teamScaleListWithFinishBlock:(void (^)(NSArray *))arg1;
- (void)jobTitleListWithIndustryCode:(NSString *)arg1 finishBlock:(void (^)(NSArray *))arg2;
...
- (void)contactOfServerWithUIDs:(NSArray *)arg1 successBlock:(void (^)(NSArray *))arg2 failureBlock:(void (^)(id <IMError>))arg3;
...
- (void)contactWithDingAccount:(NSString *)arg1 successBlock:(void (^)(DTContact *))arg2 failureBlock:(void (^)(id <IMError>))arg3;
- (DTContact *)contactWithUID:(long long)arg1 version:(long long)arg2;
- (void)contactWithUID:(long long)arg1 isSyncSave:(_Bool)arg2 successBlock:(void (^)(DTContact *))arg3 failureBlock:(void (^)(id <IMError>))arg4;
