...
@class DTBizConversation, DTEmptyResultView, DTPickerAvatarView, DTPickerStatus, NSArray, NSString, UIActivityIndicatorView, UITableView;

@interface DTSearchGroupMemberViewController : DTContactBaseViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, DTPickerAvatarViewDelegate>
{
