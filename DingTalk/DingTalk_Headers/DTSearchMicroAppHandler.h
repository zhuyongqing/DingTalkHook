...
@class DTLoadMoreController, DTSearchHomeHistoryView, DTSearchHomeView, DTSearchMicroAppDataSource, DTSearchViewController, DTSectionItem, NSString;

@interface DTSearchMicroAppHandler : NSObject <DTLoadMoreDelegate, DTSearchHandlerProtocol>
{
    DTSearchViewController *_searchVC;
    NSString *_searchText;
    DTLoadMoreController *_loadMoreController;
    DTSectionItem *_sectionItem;
    DTSearchMicroAppDataSource *_searchDataSource;
...
@property(retain, nonatomic) DTSearchMicroAppDataSource *searchDataSource; // @synthesize searchDataSource=_searchDataSource;
...
- (void)loadDataSourceWithKeyword:(id)arg1 offset:(id)arg2 size:(long long)arg3 searchLog:(id)arg4;
