...
@interface DTSearchDINGDataSource : NSObject
{
    long long _tabType;
}

@property(nonatomic) long long tabType; // @synthesize tabType=_tabType;
- (void)searchDINGMessageWithQuery:(id)arg1 recursiveTime:(long long)arg2 results:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failureBlock:(CDUnknownBlockType)arg5;
