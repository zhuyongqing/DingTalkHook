...
@class DTCSpaceResultDataModel, NSNumber;

@interface DTCSpaceKnowledgeResultModel : Marshal
{
...
@property(retain, nonatomic) NSNumber *resultMsg; // @synthesize resultMsg=_resultMsg;
