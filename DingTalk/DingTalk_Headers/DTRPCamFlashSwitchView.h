...
@class UIButton;
@protocol DTRPCamFlashSwitchViewDelegate;

@interface DTRPCamFlashSwitchView : UIView
{
    _Bool _expanded;
    long long _curSwitchMode;
    id <DTRPCamFlashSwitchViewDelegate> _delegate;
...
@property(nonatomic) __weak id <DTRPCamFlashSwitchViewDelegate> delegate; // @synthesize delegate=_delegate;
