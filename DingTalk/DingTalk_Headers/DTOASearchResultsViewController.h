...
@class DTEmptyResultView, DTLoadMoreController, DTSearchLog, NSMutableArray, NSString, UITableView;

@interface DTOASearchResultsViewController : DTGlobalSearcherBaseViewController <UITableViewDataSource, UITableViewDelegate, DTLoadMoreDelegate>
{
    _Bool _isSearching;
...
- (void).cxx_destruct;
- (void)dt_searchOADataWithSearchText:(id)arg1 offset:(long long)arg2 size:(long long)arg3;
- (void)searchOADataWithSearchText:(id)arg1 offset:(long long)arg2 size:(long long)arg3;
- (void)showsSearchOAResult:(id)arg1 withSearchText:(id)arg2;
