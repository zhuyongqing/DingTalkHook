...
- (id)utmcStaticBinarySafeDecryptNoB64ForOpen:(long long)arg1 forKey:(id)arg2 forNeedProcessValue:(id)arg3 authCode:(id)arg4;
- (id)signRequestForOpen:(id)arg1 param:(id)arg2 requestType:(long long)arg3;
- (id)getAppKeyForOpen:(int)arg1 authCode:(id)arg2;
...
- (id)getAppKeyForNotOpen:(int)arg1 authCode:(id)arg2;
- (void)initSecurityForNotOpen;
- (void)setSecurityStatus;
- (id)utmcGetUmid;
- (id)utmcStaticBinarySafeDecryptNoB64:(long long)arg1 forKey:(id)arg2 forNeedProcessValue:(id)arg3 authCode:(id)arg4;
