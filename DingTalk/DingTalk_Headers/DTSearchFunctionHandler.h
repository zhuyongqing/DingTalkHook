...
@class DTLoadMoreController, DTSearchFunctionDataSource, DTSearchHomeHistoryView, DTSearchHomeView, DTSearchViewController, DTSectionItem, NSString;

@interface DTSearchFunctionHandler : NSObject <DTLoadMoreDelegate, DTSearchHandlerProtocol>
{
    ...
    DTSearchFunctionDataSource *_searchDataSource;
}

@property(retain, nonatomic) DTSearchFunctionDataSource *searchDataSource; // @synthesize searchDataSource=_searchDataSource;
...
- (void)loadDataSourceWithKeyword:(id)arg1 offsetString:(id)arg2 size:(long long)arg3 orgId:(long long)arg4 filterModel:(id)arg5 searchLog:(id)arg6;
- (void)searchDataWithKeyword:(id)arg1 searchLog:(id)arg2;
