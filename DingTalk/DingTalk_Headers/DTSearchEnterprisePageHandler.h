...
@class DTLoadMoreController, DTSearchEnterprisePageDataSource, DTSearchHomeHistoryView, DTSearchHomeView, DTSearchViewController, DTSectionItem, NSString, UIView;

@interface DTSearchEnterprisePageHandler : NSObject <DTLoadMoreDelegate, DTSearchHandlerProtocol>
{
    DTSearchViewController *_searchVC;
    NSString *_searchText;
    DTLoadMoreController *_loadMoreController;
    DTSectionItem *_sectionItem;
    DTSectionItem *_moreResultItem;
    DTSearchEnterprisePageDataSource *_searchDataSource;
...
@property(retain, nonatomic) DTSearchEnterprisePageDataSource *searchDataSource; // @synthesize searchDataSource=_searchDataSource;
@property(retain, nonatomic) DTSectionItem *moreResultItem; // @synthesize moreResultItem=_moreResultItem;
