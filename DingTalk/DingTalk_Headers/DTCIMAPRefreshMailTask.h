...
@class DTCFolder, DTCIMAPFetchInfosQueue, DTIMAPAccount, NSArray, NSMutableArray;

@interface DTCIMAPRefreshMailTask : BLBaseAPITask
{
    DTCFolder *_folder;
    NSArray *_folders;
    ...
    DTCIMAPFetchInfosQueue *_infosQueue;
}

@property(retain, nonatomic) DTCIMAPFetchInfosQueue *infosQueue; // @synthesize infosQueue=_infosQueue;
...
- (void)fetchMailsUIDWithUIDSet:(id)arg1 withFolder:(id)arg2;
- (void)firstFetchUID;
- (void)process;
