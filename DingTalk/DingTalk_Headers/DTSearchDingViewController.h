...
@class DTEmptyResultView, DTLoadMoreController, DTSearchLog, DTTableLoadingView, NSArray, NSString, UITableView;

@interface DTSearchDingViewController : DTContactBaseViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, DTLoadMoreDelegate>
{
...
- (void)showsSearchResultsBySenderGoupWithSearchText:(id)arg1;
- (void)showDingSearchResults:(id)arg1 searchText:(id)arg2;
- (void)showsSearchResultsByDingsWithSearchText:(id)arg1;
