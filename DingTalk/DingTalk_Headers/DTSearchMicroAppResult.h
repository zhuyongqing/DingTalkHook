...
@interface DTSearchMicroAppResult : Marshal
{
    _Bool _hasMore;
    NSArray *_microAppModelList;
...
@property(copy, nonatomic) NSArray *microAppModelList; // @synthesize microAppModelList=_microAppModelList;
- (void).cxx_destruct;
- (id)filedsMeta__;
- (id)init;
