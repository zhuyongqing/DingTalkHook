...
@class CALayer, MAShape, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIColor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WXBoxShadow, WXSDKInstance, WXThreadSafeCounter, WXTouchGestureRecognizer, WXTransform;
...
@property(retain, nonatomic) MAShape *shape; // @dynamic shape;
