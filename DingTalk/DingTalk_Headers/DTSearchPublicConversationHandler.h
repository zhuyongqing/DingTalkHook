...
@class DTLoadMoreController, DTSearchConversationDataSource, DTSearchHomeHistoryView, DTSearchHomeView, DTSearchViewController, DTSectionItem, NSString;

@interface DTSearchPublicConversationHandler : NSObject <DTLoadMoreDelegate, DTSearchHandlerProtocol>
{
    DTSearchViewController *_searchVC;
    NSString *_searchText;
    DTLoadMoreController *_loadMoreController;
    DTSectionItem *_sectionItem;
    DTSearchConversationDataSource *_searchDataSource;
...
@property(retain, nonatomic) DTSearchConversationDataSource *searchDataSource; // @synthesize searchDataSource=_searchDataSource;
