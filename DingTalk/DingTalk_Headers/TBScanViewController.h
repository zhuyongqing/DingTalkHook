...
@class NSMutableDictionary, NSString, TBScanCamCaptureManager, TBScanResult, UIImageView, UIPinchGestureRecognizer, UIPopoverController, UITapGestureRecognizer, UIView;
...
@interface TBScanViewController : UIViewController <UIImagePickerControllerDelegate, UIPopoverControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate>
{
    ...
    UIImageView *_lastRecognizeImage;
...
@property(retain, nonatomic) UIImageView *lastRecognizeImage; // @synthesize lastRecognizeImage=_lastRecognizeImage;
...
- (void)userAlipayLog_private:(id)arg1;
