...
@class DTAudioProcessingQueue, NSMutableData, NSString;

@interface DTOggOpusWriter : NSObject
{
    NSString *_outputPath;
    NSMutableData *_dataBuffer;
    DTAudioProcessingQueue *_writingQueue;
...
- (_Bool)beginWithOutputPath:(id)arg1;
- (void)cleanup;
- (void)dealloc;
- (id)init;
