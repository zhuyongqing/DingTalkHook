...
@interface DTCSpaceSaveShareParam : Marshal
{
    NSString *_shortLink;
    NSString *_password;
    NSArray *_ids;
    NSNumber *_targetSpaceId;
    NSNumber *_targetFolderId;
}

@property(retain, nonatomic) NSNumber *targetFolderId; // @synthesize targetFolderId=_targetFolderId;
