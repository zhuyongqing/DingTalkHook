...
@class MASMCalloutBackgroundView, NSString, UIButton, UILabel;
@protocol MASMCalloutViewDelegate;

@interface MASMCalloutView : UIView <CAAnimationDelegate>
{
    _Bool _popupCancelled;
    id <MASMCalloutViewDelegate> _delegate;
    NSString *_title;
    NSString *_subtitle;
    ...
    MASMCalloutBackgroundView *_backgroundView;
    UIView *_titleView;
...
@property(retain, nonatomic) MASMCalloutBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
...
@property(nonatomic) __weak id <MASMCalloutViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)layoutSubviews;
