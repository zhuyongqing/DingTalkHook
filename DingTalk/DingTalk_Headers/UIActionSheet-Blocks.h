...
+ (id)showInView:(id)arg1 withTitle:(id)arg2 cancelButtonTitle:(id)arg3 destructiveButtonIndex:(long long)arg4 otherButtonTitles:(id)arg5 tapBlock:(CDUnknownBlockType)arg6;
