...
@class DTCMailListFilterCondition, LWFetchRequest, LWFetchedResultsController, NSArray, NSDictionary, NSString, UITableView;

@interface DTCMailListDataSourceV1 : NSObject <LWFetchedResultsControllerDelegate>
{
    _Bool _isThread;
    _Bool _isRefreshing;
...
- (void)refreshFolder:(id)arg1 completionBlock:(CDUnknownBlockType)arg2 failureBlock:(CDUnknownBlockType)arg3;
