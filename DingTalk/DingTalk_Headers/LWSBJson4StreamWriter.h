...
@class LWSBJson4StreamWriterState, NSMutableArray, NSMutableDictionary, NSString;
@protocol LWSBJson4StreamWriterDelegate;

@interface LWSBJson4StreamWriter : NSObject
{
    NSMutableDictionary *cache;
    _Bool _humanReadable;
    _Bool _sortKeys;
    LWSBJson4StreamWriterState *_state;
    NSMutableArray *_stateStack;
    id <LWSBJson4StreamWriterDelegate> _delegate;
...
@property(nonatomic) __weak id <LWSBJson4StreamWriterDelegate> delegate; // @synthesize delegate=_delegate;
@property(readonly, nonatomic) NSMutableArray *stateStack; // @synthesize stateStack=_stateStack;
@property(nonatomic) __weak LWSBJson4StreamWriterState *state; // @synthesize state=_state;
- (void).cxx_destruct;
