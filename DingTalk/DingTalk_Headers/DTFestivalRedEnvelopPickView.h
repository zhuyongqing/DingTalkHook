...
@class DTAvatarView, DTFestivalRedEnvelopPickViewItem, DTIconNameView, UIButton, UIImageView, UILabel;

@interface DTFestivalRedEnvelopPickView : UIView
{
    DTFestivalRedEnvelopPickViewItem *_item;
...
@property(retain, nonatomic) DTFestivalRedEnvelopPickViewItem *item; // @synthesize item=_item;
- (void).cxx_destruct;
- (void)unpack;
