...
@class DTBizConversation, DTContactItem, DTPickerAvatarView, DTPickerStatus, DTSearchBar, DTSearchDisplayController, DTSearchGroupMemberViewController, NSArray, NSMutableArray, NSSet, NSString, UITableView;

@interface DTPickerMembersViewController : DTContactBaseViewController <UITableViewDataSource, UITableViewDelegate, DTSearchDisplayControllerDelegate, DTPickerAvatarViewDelegate, UISearchBarDelegate>
{
