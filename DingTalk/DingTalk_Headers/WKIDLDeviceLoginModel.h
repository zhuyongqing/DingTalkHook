...
@interface WKIDLDeviceLoginModel : Marshal
{
    NSString *_domain;
    NSString *_appKey;
    NSString *_nonce;
    ...
    NSString *_signature;
    NSString *_deviceId;
    NSNumber *_accessTokenPeriod;
}

@property(retain, nonatomic) NSNumber *accessTokenPeriod; // @synthesize accessTokenPeriod=_accessTokenPeriod;
