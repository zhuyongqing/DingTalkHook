...
@class DTMessageBubbleTextParserResult, NSArray, NSAttributedString, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIBezierPath, UIColor, UIFont, YYTextContainer, YYTextDebugOption, YYTextHighlight, YYTextLayout;
@protocol YYTextLinePositionModifier, YYTextParser;

@interface YYLabel : UIView <YYTextDebugTarget, YYAsyncLayerDelegate, NSCoding>
{
...
- (void)fixLastNewline10Bug;
@property(retain, nonatomic) DTMessageBubbleTextParserResult *parserResult; // @dynamic parserResult;
