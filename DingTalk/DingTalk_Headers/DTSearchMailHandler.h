...
@class DTLoadMoreController, DTSearchHomeHistoryView, DTSearchHomeView, DTSearchMailDataSource, DTSearchViewController, DTSectionItem, NSString;

@interface DTSearchMailHandler : NSObject <DTLoadMoreDelegate, DTSearchHandlerProtocol>
{
    DTSearchViewController *_searchVC;
    NSString *_searchText;
    DTLoadMoreController *_loadMoreController;
    DTSectionItem *_sectionItem;
    DTSearchMailDataSource *_searchDataSource;
...
@property(retain, nonatomic) DTSearchMailDataSource *searchDataSource; // @synthesize searchDataSource=_searchDataSource;
