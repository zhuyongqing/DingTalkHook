...
@class DTAvatarView, DTIconView, DTNameCardListCellItem, DTUserNameLabel, NSString, UIImageView;

@interface DTNameCardListCell : DTBaseCell <DTUserNameLabelDelegate>
{
    DTNameCardListCellItem *_cellItem;
...
@property(retain, nonatomic) DTNameCardListCellItem *cellItem; // @synthesize cellItem=_cellItem;
- (void).cxx_destruct;
