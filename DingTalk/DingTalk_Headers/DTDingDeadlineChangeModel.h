...
@interface DTDingDeadlineChangeModel : Marshal
{
    NSNumber *_dingId;
    NSNumber *_currentDeadLine;
...
@property(retain, nonatomic) NSNumber *currentDeadLine; // @synthesize currentDeadLine=_currentDeadLine;
