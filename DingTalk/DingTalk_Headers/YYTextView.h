...
@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIColor, UIFont, UIImageView, UITextPosition, UITextRange, UIView, YYTextContainer, YYTextContainerView, YYTextDebugOption, YYTextHighlight, YYTextLayout, YYTextMagnifier, YYTextRange, YYTextSelectionView;
