...
@class LWPDDLogFileInfo, NSFileHandle, NSObject, NSString;
@protocol LWPDDLogFileManager, OS_dispatch_source;

@interface LWPDDFileLogger : LWPDDAbstractLogger <LWPDDLogger>
{
    id <LWPDDLogFileManager> logFileManager;
    LWPDDLogFileInfo *currentLogFileInfo;
...
@property(readonly, nonatomic) id <LWPDDLogFileManager> logFileManager; // @synthesize logFileManager;
- (void).cxx_destruct;
- (id)loggerName;
