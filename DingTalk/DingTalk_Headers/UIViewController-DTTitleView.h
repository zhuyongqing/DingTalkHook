...
@interface UIViewController (DTTitleView)
...
- (void)dt_clickEvent:(id)arg1;
@property(copy, nonatomic) CDUnknownBlockType titleViewClickBlock;
- (void)dt_setTitle:(id)arg1 subTitle:(id)arg2 iconImage:(id)arg3;
- (void)dt_setTitle:(id)arg1 subTitle:(id)arg2;
@end
