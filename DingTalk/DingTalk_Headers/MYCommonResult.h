...
@interface MYCommonResult : NSObject
{
    _Bool _success;
    int _showType;
    NSString *_resultCode;
    NSString *_resultDesc;
    NSString *_resultViewTitle;
...
@property(retain, nonatomic) NSString *resultViewTitle; // @synthesize resultViewTitle=_resultViewTitle;
