...
@class BLFavoriteDing, NSString;

@interface BLFavoriteContent : BLYapObjectWithAccount
{
    NSString *_cid;
    long long _uid;
    long long _orgId;
...
@property(retain, nonatomic) BLFavoriteDing *dingExt; // @synthesize dingExt=_dingExt;
