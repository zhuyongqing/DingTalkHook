...
+ (id)urlWithQueryItemForJoinBroup:(id)arg1 type:(int)arg2;
+ (id)urlWithQueryItemForGameBindingGroup:(id)arg1 type:(int)arg2;
+ (id)urlWithQueryItemForAddFriend:(id)arg1 type:(int)arg2;
