...
@class DTCSpaceFileInfoModel, NSNumber, NSString;

@interface DTCSpaceAclResultModel : Marshal
{
    NSNumber *_resultCode;
    NSString *_resultMessage;
    DTCSpaceFileInfoModel *_file;
}

@property(retain, nonatomic) DTCSpaceFileInfoModel *file; // @synthesize file=_file;
