...
@class HPAsyncReadPacket, HPAsyncWritePacket, NSArray, NSMutableArray, NSMutableData, NSTimer;

@interface HPAsyncSocket : NSObject
{
    ...
    HPAsyncReadPacket *theCurrentRead;
    NSTimer *theReadTimer;
    NSMutableData *partialReadBuffer;
    NSMutableArray *theWriteQueue;
    HPAsyncWritePacket *theCurrentWrite;
